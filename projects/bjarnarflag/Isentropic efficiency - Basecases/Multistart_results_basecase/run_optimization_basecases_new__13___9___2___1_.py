...
#
MODE = "batch"  # "optimize" | "sweep" | "pcond_sweep" | "k_sensitivity" | "multistart" | "parametric_study" | "batch"
...
CONFIG_FILE = Path(__file__).with_name("Simple_basecase - transcritical_n-Butane.yaml")
...
BATCH_YAML_FILES = [
    ...
    Path(__file__).with_name("Recup_basecase - transcritical_n-Butane.yaml"),
    Path(__file__).with_name("Simple_basecase - transcritical_n-Butane.yaml"),
]
...
PARAMETRIC_BASE_YAMLS = [
    ...
    Path(__file__).with_name(
        "Toluene_simple_basecase_optimized_Macchi_single_turb.yaml"
    ),
