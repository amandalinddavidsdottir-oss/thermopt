...
CONFIG_FILE = Path(__file__).with_name(
    "case_Toluene_simpleORC_macchi_astolfi_n4_rpm1000_constrain.yaml"
)
...
PCOND_TEMPLATE = Path(__file__).with_name(
    "pcondSweep_simpleORC_macchi_astolfi_n4_rpm1000.yaml"
)
