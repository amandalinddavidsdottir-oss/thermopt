...
class TurbineCorrelationResults:
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 76)
        print("  MACCHI & ASTOLFI TURBINE EFFICIENCY CORRELATION")
        print("=" * 76)
...
def evaluate_turbine_efficiency(cycle, RPM=None, stages=None):
    """
    Evaluate the Macchi & Astolfi correlation for the converged expander.
