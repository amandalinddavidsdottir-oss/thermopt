...
#
MODE = "parametric_study"  # "optimize" | "sweep" | "pcond_sweep" | "k_sensitivity" | "multistart" | "parametric_study" | "batch"
...
CONFIG_FILE = Path(__file__).with_name(
    "Toluene_dp_twosource_recup_basecase_optimized_Macchi.yaml"
)
...
PARAMETRIC_RPM_LIST = [1500, 1000, 3000]  # 1500 first — most likely to converge and gives best warmstart for subsequent RPMs
...
def run_parametric_nstages_rpm(
    ...
    for n_stages in n_stages_list:
        ...
        # spacing using transition_vars (RPM=1500 of previous n_stages block).
        ...
        for rpm in rpm_list:
            ...
            try:
                ...
                # Save transition_vars and rpm1500_vars from RPM=1500 (first in rpm_list).
                ...
                if converged and rpm == rpm_list[0]:
