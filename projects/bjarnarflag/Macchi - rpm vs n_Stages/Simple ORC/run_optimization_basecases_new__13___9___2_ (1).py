...
CONFIG_FILE = Path(__file__).with_name("Toluene_simple_basecase_optimized_Macchi.yaml")
...
PARAMETRIC_BASE_YAMLS = [
    ...
    # Path(__file__).with_name("Toluene_dp_basecase_optimized_Macchi.yaml"),
    # Path(__file__).with_name("Toluene_dp_recup_basecase_optimized_Macchi.yaml"),
