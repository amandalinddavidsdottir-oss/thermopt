...
#
MODE = "optimize"  # "optimize" | "sweep" | "pcond_sweep" | "k_sensitivity" | "multistart" | "parametric_study" | "batch"
...
PARAMETRIC_BASE_YAMLS = [
    Path(__file__).with_name("Toluene_recup_basecase_optimized_Macchi.yaml"),
...
def run_parametric_nstages_rpm(
    ...
    for n_stages in n_stages_list:
        ...
        # spacing using transition_vars (RPM=1500 result of previous n_stages block).
