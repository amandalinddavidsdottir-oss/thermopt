...
def plot_TQ_diagram(
    cycle, component_name, savefig=True, filename=None, output_dir=None
):
    """
    ...
    ax.annotate(
        "",
        xy=(pinch_Q, pinch_Thot),
        xycoords="data",
        xytext=(pinch_Q, pinch_Tcold),
        textcoords="data",
        arrowprops=dict(arrowstyle="<->", color="black", lw=1.2),
    )

    ax.set_xlabel(r"Heat duty, $\dot{Q}$ [kW]", fontsize=11)
